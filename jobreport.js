document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateReport() {
        ...
        // Display appropriate icon/message in BP% field
        if (parseFloat(bpp) < 10) {
            bppField.value = "👎 JOB BUST";
        } else if (parseFloat(bpp) >= 10.00 && parseFloat(bpp) <= 19.99) {
            bppField.value = "😬"; // Thumbs down
        } else if (parseFloat(bpp) >= 20.00 && parseFloat(bpp) <= 29.99) {
            bppField.value = "👍"; // Thumbs up
        } else if (parseFloat(bpp) >= 30.00 && parseFloat(bpp) <= 39.99) {
            bppField.value = "😀"; // Happy emoji
        } else if (parseFloat(bpp) >= 40.00 && parseFloat(bpp) <= 49.99) {
            bppField.value = "⭐"; // Solid star
        } else if (parseFloat(bpp) >= 50.00 && parseFloat(bpp) <= 59.99) {
            bppField.value = "⭐"; // Solid star
        }
